...
import { iconRegistry, IconTypes } from "./BaseIcon"
 ...
 */
export function BaseToggle(props: ToggleProps) {
  const {
    variant = "checkbox",
    editable = true,
    status,
  ...
  const Wrapper = useMemo<ComponentType<TouchableOpacityProps | any>>(
    ...
    >
      <View style={$inputWrapperStyles}>
        ...
        <ToggleInput
          ...
          status={status}
          outerStyle={props.inputOuterStyle as ViewStyle}
          innerStyle={props.inputInnerStyle as ViewStyle}
          detailStyle={props.inputDetailStyle  as ViewStyle}
  ...
  return (
    <View
      style={[
        ...
        !!offBackgroundColor && { backgroundColor: offBackgroundColor },
        !!outerBorderColor && { borderColor: outerBorderColor },
        $outerStyleOverride,
      ]}
    >
      <Animated.View
        style={[
          $checkboxInner,
          !!onBackgroundColor && { backgroundColor: onBackgroundColor },
          $innerStyleOverride,
          useAnimatedStyle(() => ({ opacity: withTiming(on ? 1 : 0) }), [on]),
        ]}
      >
        <Image
          source={iconRegistry[checkboxIcon as string] || iconRegistry.check}
...
function Radio(props: ToggleInputProps) {
  ...
  return (
    ...
    >
      ...
      >
        <View
          style={[$radioDetail, !!dotBackgroundColor && { backgroundColor: dotBackgroundColor }, $detailStyleOverride]}
        />
      </Animated.View>
    </View>
  )
    ...
    >
      ...
      <Animated.View
        style={[
          ...
          !!knobBackgroundColor && { backgroundColor: knobBackgroundColor },
        ]}
      />
    </View>
  )
