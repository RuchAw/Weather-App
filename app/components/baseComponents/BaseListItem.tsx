...
import { BaseIcon, IconTypes } from "./BaseIcon"
 ...
 */
export function BaseListItem(props: ListItemProps) {
  const {
    bottomSeparator,
    children,
    height = spacing.lg,
  ...
  return (
    <View style={$containerStyles}>
      <TouchableOpacity {...TouchableOpacityProps} style={$touchableStyles}>
        ...
        <BaseText {...TextProps} tx={tx} text={text} txOptions={txOptions} style={$textStyles}>
          {children}
        </BaseText>
