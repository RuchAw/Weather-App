 ...
 */
export function BaseEmptyState(props: EmptyStateProps) {
  const preset = EmptyStatePresets[props.preset as string] ? EmptyStatePresets[props.preset as string] : undefined
